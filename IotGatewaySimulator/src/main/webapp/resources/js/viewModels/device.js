...
define([ 'ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojmasonrylayout', 'ojs/ojbutton', 'ojs/ojswitch', 'ojs/ojchart',
	...
	function loadDevices(devicesDatasource) {
		devicesDatasource.reset();
		$.getJSON(baseUrl + "device/list").then(function(devices) {
	...
	function viewModel() {
		...
		var self = this;
		self.currentId = null;
		self.title = ko.observable('Select/Create a Device');
