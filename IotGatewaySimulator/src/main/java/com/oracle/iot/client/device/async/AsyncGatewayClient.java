...
/**
 * A GatewayDevice is a Device that is able to register a device
 * (indirect enrollment).
 */
public class AsyncGatewayClient extends AsyncDeviceClient {
    // TODO: API for registering and un-registering devices
     ...
     */
    public AsyncGatewayClient(String server, int port, String endpointId) {
        super(server, port, endpointId);
        throw new UnsupportedOperationException("AsyncGatewayClient not supported yet");
    }
